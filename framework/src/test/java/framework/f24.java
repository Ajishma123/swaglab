...
public class f24 {
	...
	String excelFilePath ="C:\\Users\\User\\Desktop\\Book4.xlsx";
	...
	String logiin = row.getCell(2).getStringCellValue();
	String mailid= row.getCell(3).getStringCellValue();
	String usspass = row.getCell(4).getStringCellValue();
	String comformpass = row.getCell(5).getStringCellValue();
